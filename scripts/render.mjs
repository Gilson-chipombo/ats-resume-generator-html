...
const html = tpl
  ...
  .replaceAll("{{LINKEDIN_TEXT}}", "linkedin.com/in/gilson-chipombo")
  .replaceAll("{{GITHUB_TEXT}}", "github.com/Gilson-chipombo")
  .replaceAll("{{WEBSITE_TEXT}}", "PORTIFÓLIO: gilsonchipombo.vercel.app")
